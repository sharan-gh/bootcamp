...
rc = {'lines.linewidth' : 2, 'axes.labelsize':18, 'axes.titlesize':1}
sns.set(rc=rc)
...
#The plot as two overlaying histograms
...
#Save the fig
plt.savefig('egg_svg_test.svg', bbox_inches='tight')
